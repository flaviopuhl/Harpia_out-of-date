void takeImage(){
 ...
 Serial.println("################# CAM start #################");
  ...
  String path = "/HarpiaPic " + currentFullDate +".jpg";  // file name with date&Time
  String pathStatic = "/HarpiaPic.jpg";                       // file name with fixed name for Thinger
